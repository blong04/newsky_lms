...
import com.newskyenglish.service.CourseService;
...
public class CourseController {
    ...
    public ResponseEntity<ApiResponse<List<ClassRoomDTO.Response>>> getCourseClasses(@PathVariable Long id) {
        return ResponseEntity.ok(ApiResponse.success(courseService.getCourseClasses(id)));
    }

    // Tạo khóa học mới trong hệ thống.
    @PostMapping
    public ResponseEntity<ApiResponse<CourseDTO.Response>> create(@RequestBody @Valid CourseDTO.CreateRequest request) {
    ...
    public ResponseEntity<ApiResponse<CourseDTO.Response>> update(
            ...
            @RequestBody @Valid CourseDTO.UpdateRequest request) {
